...
SET LibName=customer-lib.jar
SET LibPath=%NetBeansProjects%\customer-lib\customer-lib\dist\customer-lib.jar

del %NetBeansProjects%\fulltestAPI\lib\%LibName%
del %NetBeansProjects%\stealerAPI\stealerAPI\lib\%LibName%
